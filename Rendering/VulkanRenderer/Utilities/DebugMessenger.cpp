...
void DebugMessenger::setupDebugMessenger(VkInstance* pVkInstance, bool enableValidationLayers)
{
	m_pInstance = pVkInstance;
	...
	if (CreateDebugUtilsMessengerEXT(*m_pInstance, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS) {
...
{
	DestroyDebugUtilsMessengerEXT(*m_pInstance, debugMessenger, nullptr);
}